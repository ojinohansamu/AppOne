...
public class RouteInfoSER implements Serializable{
    ...
    public String toString() {
        return "RouteInfoSER{" +
                ...
                ", DISPLAY_PRICE_IND='" + DISPLAY_PRICE_IND + '\'' +
                ", DEX_SIGNATURE_CODE='" + DEX_SIGNATURE_CODE + '\'' +
                ", LOAD_SECURITY_CODE='" + LOAD_SECURITY_CODE + '\'' +
                ", RETURN_SECURITY_CODE='" + RETURN_SECURITY_CODE + '\'' +
                ", COMMUNICATION_SECURITY_CODE='" + COMMUNICATION_SECURITY_CODE + '\'' +
                ", DNL_DATE='" + DNL_DATE + '\'' +
                ", INVOICE_MARKET_ID='" + INVOICE_MARKET_ID + '\'' +
                ", SLF_PLUS_IND='" + SLF_PLUS_IND + '\'' +
                ", STD_ORD_CONTROL_CODE='" + STD_ORD_CONTROL_CODE + '\'' +
                ", OVERSELL_LOAD_IND='" + OVERSELL_LOAD_IND + '\'' +
                ", DEPOT_NAME='" + DEPOT_NAME + '\'' +
                ", UNLOCK_STOPS_IND='" + UNLOCK_STOPS_IND + '\'' +
                ", PRESET_ORDER_IND='" + PRESET_ORDER_IND + '\'' +
                ", ORDER_CHANGE_CODE='" + ORDER_CHANGE_CODE + '\'' +
                ", ROUTE_LEVEL_ORDER_IND='" + ROUTE_LEVEL_ORDER_IND + '\'' +
                ", SCREEN_SECURITY_CODE='" + SCREEN_SECURITY_CODE + '\'' +
                ", COMM_TIME='" + COMM_TIME + '\'' +
                ", DISABLE_ADD_CO_IND='" + DISABLE_ADD_CO_IND + '\'' +
                ", ADDITIONAL_CONTROLS_IND='" + ADDITIONAL_CONTROLS_IND + '\'' +
                ", ZERO_DISTRIBUTION_IND='" + ZERO_DISTRIBUTION_IND + '\'' +
                ", DELAYED_CASH_IND='" + DELAYED_CASH_IND + '\'' +
                ", DEF_RET_LOCATION='" + DEF_RET_LOCATION + '\'' +
                '}';
    }
